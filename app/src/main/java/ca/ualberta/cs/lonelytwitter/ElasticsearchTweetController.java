...
public class ElasticsearchTweetController {
    ...
    public static void setClient(){
        if (client == null){
            DroidClientConfig config = new DroidClientConfig.Builder(
                    "http://cmput301.softwareprocess.es:8080/").build();
    ...
    public static class AddTweetTask extends AsyncTask<Tweet, Void, Void>{
        ...
        protected Void doInBackground(Tweet... params){
            ...
            Index index = new Index.Builder(tweet).index("shaiful-thursday").type("tweet").build();
            try{
    ...
    public static class GetTweekTasks extends AsyncTask<String, Void, ArrayList<Tweet>>{
